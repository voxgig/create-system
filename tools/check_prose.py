...
Run it directly, or `npm run scan-prose`. `--files` prints the page set both
...
# pages). Off here: this is a single TypeScript package.
PORT_DIRS = False
NOT_PORTS = ()
PORT_PAGES = ()
...
WORKING_DOCS = (
    ...
    (r"\bCOVERAGE\.md\b", "ci/COVERAGE.md"),
...
REQUIRED_PAGES = (
    "docs/explanation/scaffold-design.md",
    "docs/how-to/develop-the-scaffold.md",
    "docs/reference/generated-structure.md",
    "docs/tutorial.md",
)
REQUIRED_PORTS = ()
